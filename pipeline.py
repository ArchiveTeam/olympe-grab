...
LUA_SHA1 = get_hash(os.path.join(CWD, 'olympe.lua'))
...
project = Project(
    title="olympe",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/5/55/Olympe_logo.png" height="50px" title=""/>
        <h2>olympe.in <span class="links"><a href="http://olympe.in">Website</a> &middot; <a href="http://tracker.archiveteam.org/olympe/">Leaderboard</a></span></h2>
        <p>Archiving all olympe sites.</p>
    """,
    utc_deadline=datetime.datetime(2016, 6, 4, 23, 59, 0)
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="olympe"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
